...
function Welcome() {
  return (
    <div className='welcome-container' id='accueil'>
       ...
       <p className='welcome-typing'>Je suis actuellement à la recherche d'un post de Développeuse Web en <span className='welcome-typing--animation'>alternance.</span></p>
