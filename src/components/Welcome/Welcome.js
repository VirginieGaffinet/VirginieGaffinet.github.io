...
function Welcome() {
  return (
    <div className='welcome-container' id='accueil'>
       <h2 className='welcome-title'>Référente d'applications numériques</h2>
       <p className='welcome-typing'>Je suis actuellement à la recherche d'un poste dans le métier du <span className='welcome-typing--animation'>numérique.</span></p>
